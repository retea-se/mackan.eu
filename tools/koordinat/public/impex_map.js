...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (clearButton) {
    clearButton.addEventListener("click", () => {
      ...
      document.getElementById("total-distance").textContent = "Total sträcka: 0 m";
      ...
      document.getElementById("terminal-lines").textContent = "";
      document.getElementById("hacker-output").classList.add("hidden");
  ...
  function updateHackerOutput(data, segment = "") {
    ...
    const div = document.getElementById("hacker-output");
