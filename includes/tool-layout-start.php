<?php
// tool-layout-start.php - v1
// Layout för verktyg med landningssidans design
// Använder samma navigation och footer som landningssidan
...
<body>
  <!-- Navigation med landningssidans design -->
